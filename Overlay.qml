...
" +
  ...
  Process { id: saveDraftProc; command: [] }
  ...
  PanelWindow {
    ...
    color: "transparent"
    WlrLayershell.namespace: "hyc-capture"
    ...
    Rectangle {
      ...
      Column {
        ...
        TextEdit {
          id: input
          width: parent.width
          implicitHeight: Math.min(160, Math.max(48, contentHeight + Style.space(4)))
          color: root.foreground
          ...
          Text {
            ...
            text: "记点什么… (Enter 发送 · Shift+Enter 换行 · Esc 关闭)"
            color: root.muted
            font.pixelSize: Style.font.body
            anchors.fill: parent
            anchors.margins: 4
